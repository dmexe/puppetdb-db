...
(function() {
  ...
  describe('Event', function() {
    beforeEach(function() {
      ...
      return event = new App.Event(attrs);
    });
    it('should has timestamp', function() {
      var tm;
      tm = Date.parse(timestamp.toString());
      return expect(event.timestamp).toEqual(tm);
    });
    it("should has timeAt", function() {
      var tm;
      tm = timestamp.toLocaleTimeString();
      return expect(event.timeAt).toEqual(tm);
    });
    return it("should has resource", function() {
      return expect(event.resource).toEqual("File[/etc]");
    });
  });
...
(function() {
  ...
  describe('Metrics', function() {
    beforeEach(function() {
      ...
      return metrics = new App.Metrics(attrs);
    });
    return it("should has avgResourcesPerNode()", function() {
      return expect(metrics.avgResourcesPerNode()).toEqual(10);
    });
  });

}).call(this);
(function() {
  var attrs, monthlyStats, timestamp;
  ...
  describe('MonthlyStats', function() {
    beforeEach(function() {
      ...
      return monthlyStats = new App.MonthlyStats(attrs);
    });
    return describe(".forChart()", function() {
      return it("should build hash for chart", function() {
        ...
        return expect(monthlyStats.forChart().requests).toEqual([3]);
      });
    });
  });
...
(function() {
  ...
  describe('Node', function() {
    beforeEach(function() {
      ...
      return node = new App.Node(attrs);
    });
    it("should has link", function() {
      return expect(node.link).toEqual("/nodes/example.com");
    });
    it("should has reportAtTimestamp()", function() {
      var tm;
      tm = Date.parse(timestamp.toString());
      return expect(node.reportAtTimestamp()).toEqual(tm);
    });
    it("should has reportAt()", function() {
      return expect(node.reportAt()).toEqual(timestamp.toLocaleString());
    });
    return xit("should has fact()");
  });
